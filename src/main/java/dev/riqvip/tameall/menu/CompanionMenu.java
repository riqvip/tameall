...
public final class CompanionMenu extends AbstractContainerMenu {
    ...
    public static final int CARGO_START = EQUIPMENT_SIZE;
    public static final int COMPANION_SIZE = EQUIPMENT_SIZE + 27;
    ...
    private CompanionMenu(int id, Inventory inventory, Container companion,
        ...
        for (int row = 0; row < 3; row++) {
            for (int column = 0; column < 9; column++) {
                addSlot(new Slot(companion, CARGO_START + row * 9 + column,
